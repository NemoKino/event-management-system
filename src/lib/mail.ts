...
export async function sendAdminNotification(eventData: {
    ...
    const fromEmail = process.env.RESEND_FROM_EMAIL || 'Event Platform <noreply@event-recruiter.com>';
        ...
        const result = await resend.emails.send({
            ...
            html: `
                <div style="font-family: sans-serif; line-height: 1.6; color: #333;">
                    ...
                    <p>Event Recruiter に新しいイベントの掲載申請が届きました。</p>
                    ...
                    <p style="font-size: 12px; color: #94a3b8;">
                        ※このメールは Event Recruiter のシステムより自動送信されています。
                    </p>
                </div>
            `,
        });
