            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    <div style={{ padding: '1rem', background: '#f8fafc', borderRadius: '4px' }}>
                        <p style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>申請者連絡先</p>
                        {targetEventForDM?.organizer?.contactUrl ? (
                            <a
                                href={targetEventForDM.organizer.contactUrl}
                                target="_blank"
