        ...
        <div className={styles.formContainer}>
            ...
            <form className={styles.form} onSubmit={handleConfirm}>
                ...
                <div className={styles.formGroup}>
                    ...
                    <textarea name="requirementsText" placeholder="Play time 500h+&#13;&#10;Discord required" className={styles.textarea} value={formData.requirementsText} onChange={handleChange} style={{ minHeight: '100px' }} />
                </div>
